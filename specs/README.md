...
| SPEC-005 | sandboxing + quarantine | ✅ Parts A+B shipped v1.1.0–v1.2.0; Part C (exec sandbox) dropped — out of scope, harnesses own execution | `bda46f9` | [quarantine](../docs/quarantine.md) |
